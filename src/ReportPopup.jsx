...
const ReportPage = () => {
  ...
  // Retrieve and parse reportData from localStorage
  useEffect(() => {
    ...
    if (storedData) {
      ...
      setParsedSummary("<p>No report data available.</p>");
    }
  }, []);
  ...
  return (
    <div className="report-page">
      <div className="popup_container">
        <img src="/balmer_logo.svg" alt="BALMER AGENCY" className="report-logo"></img>
